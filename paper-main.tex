...
\begin{figure}[htp]
  \begin{subfigure}{\linewidth}
    ...
    \includegraphics[width=\linewidth]{images/gen-focal-1.pdf}
    \label{fig:fUp}
  \end{subfigure}
  \hspace{1em}
  \begin{subfigure}{\linewidth}
    \caption{SoH down for focal size}
    \includegraphics[width=\linewidth]{images/gen-focal-2.pdf}
    \label{fig:fDown}
  \end{subfigure}
...
\begin{figure}[htp]
  \begin{subfigure}{\linewidth}
    ...
    \includegraphics[width=\linewidth]{images/gen-weight-1.pdf}
    \label{fig:wUp}
  \end{subfigure}
  \hspace{1em}
  \begin{subfigure}{\linewidth}
    \caption{SoH down for weight size}
    \includegraphics[width=\linewidth]{images/gen-weight-2.pdf}
    \label{fig:wDown}
  \end{subfigure}
...
\begin{figure*}[htp]
  ...
  \end{tabular}
  \begin{tabular}{cccccccc}
    \multicolumn{8}{l}{Focal G* Multiple aggregation levels} \\
    \hline
  ...
  \includegraphics[width=.48\linewidth]{images/gen-zoom-sohup-1}
  \hspace{1em}
  \includegraphics[width=.48\linewidth]{images/gen-zoom-sohdown-1}
...
\begin{figure*}[htp]
  ...
  \end{tabular}
  \begin{tabular}{cccccccc}
    \multicolumn{8}{l}{G* Multiple weight matrix sizes} \\
    \hline
    \includegraphics[width=4.6em]{images/gen-raw-zoom-gstar-1}&
    \includegraphics[width=4.6em]{images/gen-raw-zoom-gstar-2}&
    \includegraphics[width=4.6em]{images/gen-raw-zoom-gstar-3}&
  ...
  \end{tabular}
  \begin{tabular}{cccccccc}
    \multicolumn{8}{l}{Focal G* Multipleweight matrix sizes} \\
    \hline
    \includegraphics[width=4.6em]{images/gen-raw-zoom-focalgstar-1}&
    \includegraphics[width=4.6em]{images/gen-raw-zoom-focalgstar-2}&
    \includegraphics[width=4.6em]{images/gen-raw-zoom-focalgstar-3}&
