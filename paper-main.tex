...
In this study, we examine the impact of key parameter on the stability of the hotspots, namely the size of the neighbourhood (blurr), the resolution (zoom) and the size of the study area, as well as the influence of the ratio between those parameter.
