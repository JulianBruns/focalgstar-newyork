...
\begin{figure*}[htp]
  ...
  \includegraphics[width=.45\linewidth]{images/gen-aggregation-1}
  \hspace{1em}
  \includegraphics[width=.45\linewidth]{images/gen-aggregation-2}
...
\begin{figure*}[htp]
  ...
  \includegraphics[width=.45\linewidth]{images/gen-weight-1}
  \hspace{1em}
  \includegraphics[width=.45\linewidth]{images/gen-weight-2}
