...
dataset we used the $pickup_longitude$ and $pickup_latitude$ column. 
...
In figure ~\ref{TODO Up} you can see that an increase of the focal size leads to better results for $SoH^{\uparrow}$. 
...
$SoH^{\downarrow}$ in figure ~\ref{TODO Down} reaches its maximum for focal size F 65x65 in the regarded area.
%
% Weight size
...
In figure ~\ref{TODO wDown} one can see that an increase of the weight size leads to better results.
...
In figure ~\ref{TODO wUp} the break downs are also visible.
The high standard deviation indicates that it is possible to use this parametrisation for better results
The $SoH^{\uparrow}$ in ~\ref{TODO wUp} is mostly better than $G^*$ which was our conclusion in \ref{TODO last paper}.
%
% Zoom
...
The last variation we examined was the zoom level. One can see that $G^*$ is always better than Focal $G^*$.
The target area of Focal $G^*$ increases if you zoom out. 
