...
plot(NA, ylab="Up", xlim=c(7,43), ylim=c(0,1), xlab=sprintf("Weight"))
...
plot(NA, ylab="Down", xlim=c(7,43), ylim=c(0,1), xlab=sprintf("Weight"))
plotCI(x=mean$Group.1, y=mean$x, uiw=sd$x, err="y", pch=20, slty=3, scol = "red", add=TRUE)
plotCI(x=meanG$Group.1, y=meanG$x, uiw=sdG$x, err="y", pch=20, slty=3, scol = "blue", add=TRUE)
lines(mean$Group.1, mean$x, col="red", lw=4)
lines(meanG$Group.1, meanG$x, col="blue", lw=4)
...
plot(NA, ylab="Up", xlim=c(2,6), ylim=c(0,1), xlab=sprintf("Aggregation"))
plotCI(x=mean$Group.1, y=mean$x, uiw=sd$x, err="y", pch=20, slty=3, scol = "red", add=TRUE)
plotCI(x=meanG$Group.1, y=meanG$x, uiw=sdG$x, err="y", pch=20, slty=3, scol = "blue", add=TRUE)
lines(mean$Group.1, mean$x, col="red", lw=4)
lines(meanG$Group.1, meanG$x, col="blue", lw=4)
...
plot(NA, ylab="Down", xlim=c(2,6), ylim=c(0,1), xlab=sprintf("Aggregation"))
plotCI(x=mean$Group.1, y=mean$x, uiw=sd$x, err="y", pch=20, slty=3, scol = "red", add=TRUE)
plotCI(x=meanG$Group.1, y=meanG$x, uiw=sdG$x, err="y", pch=20, slty=3, scol = "blue", add=TRUE)
lines(mean$Group.1, mean$x, col="red", lw=4)
lines(meanG$Group.1, meanG$x, col="blue", lw=4)
...
plot(NA, ylab="Up", xlim=c(29,137), ylim=c(0,1), xlab=sprintf("Focal"))
plotCI(x=mean$Group.1, y=mean$x, uiw=sd$x, err="y", pch=20, slty=3, scol = "red", add=TRUE)
lines(mean$Group.1, mean$x, col="red", lw=4)
...
plot(NA, ylab="Down", xlim=c(29,137), ylim=c(0,1), xlab=sprintf("Focal"))
plotCI(x=mean$Group.1, y=mean$x, uiw=sd$x, err="y", pch=20, slty=3, scol = "red", add=TRUE)
lines(mean$Group.1, mean$x, col="red", lw=4)
legend("topleft", c("Focal G*") , fill=c("red"))
