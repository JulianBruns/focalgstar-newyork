...
blur_soh %>% dplyr::select(Blur, "G*" = UpBlur) -> y1
blur_soh %>% dplyr::select(Blur, "Focal G*" = UpFocalBlur) -> y2
...
blur_soh %>% dplyr::select(Blur, "G*" = DownBlur) -> y1
blur_soh %>% dplyr::select(Blur, "Focal G*" = DownFocalBlur) -> y2
